...
class TestSo3kratesInit:
    ...
    def test_init_with_different_radial_basis(self, default_model_config):
    ...
    def test_init_with_different_cutoff_fn(self, default_model_config):
...
class TestSO3LRInit:
    ...
    def test_init_creates_lr_components(self, so3lr_model_config):
