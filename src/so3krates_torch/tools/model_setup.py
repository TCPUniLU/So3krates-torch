...
def create_model(config: dict, device: torch.device) -> SO3LR:
    ...
    dispersion_needs_lr = dispersion_bool
    if (electrostatics_needs_lr or dispersion_needs_lr) and r_max_lr is None:
        raise ValueError(
            ...
            "is True (and the corresponding PME flag is False). "
    ...
    model_params = {
        ...
        "use_rms_norm": arch_config.get("use_rms_norm", False),
        ...
        "pme_dispersion_smearing": arch_config.get(
            "pme_dispersion_smearing", None
        ),
        "pme_dispersion_mesh_spacing": arch_config.get(
            "pme_dispersion_mesh_spacing", None
        ),
        "legacy_dispersion_bool": arch_config.get(
